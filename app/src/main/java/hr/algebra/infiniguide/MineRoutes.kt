...
class MineRoutes : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mine_routes)
        ...
        val imageView1 = findViewById<ImageView>(R.id.goBackArrow)
    ...
    private fun showRoutes(routes: List<Route>) {
        rvItems.layoutManager = LinearLayoutManager(this@MineRoutes)
